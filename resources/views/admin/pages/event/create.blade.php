        ...
        <div class="card-body">
            ...
            <form action="/admin/event" class="forms-sample" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="menu" name="title" autocomplete="off" placeholder="judul">
                </div>

                <div class="form-group mb-3">
                    <label for="menu">tanggal</label>
                    <input type="date" class="form-control" id="menu" name="date" autocomplete="off" placeholder="tanggal">
                </div>

                <div class="form-group mb-3">
                    <label>upload foto</label>
                    <div class="input-group col-xs-12">
                        <input type="file" class="form-control file-upload-info" onChange="previewImage()" placeholder="Upload Image" id="image" name="image">
                    </div>
                </div>
