...
<div class="row bg-light">
    <h5 class="text-center">seacoffe</h5>
</div>
...
{{-- <div class="row border marque-group">
        <p>wkkw</p>
    </div> --}}
<div class=" row mx-2 mx-sm-2 mx-md-1">
    {{-- SECTION HOT --}}
    <section id="sec-kategori-hot" class="p-0 ">
        <h3 class="mt-5"> Hot</h3>
            ...
            <div class="card cards-menus  ps-2 me-md-2 mb-2">
                ...
                <div class="row g-0">
                    <div class="col-4 col-sm-4 col-md-4 py-2 ">
                        <img src="{{ asset('storage/' . $menu->gambar) }}" class="rounded menu-gambar" alt="{{ $menu->nama }}" width="100%" height="100%">
                    </div>
                        ...
                        <div class="menuItems card-body">
                            ...
                            <div class="d-flex bd-highlight ">
                                <div class="bd-highlight ">
                                    <p class="priceElementItems card-text pt-3 text-danger fw-bold" style="font-size: 12px">
                                        Rp. {{ $menu->harga }}
                                    </p>
                                </div>
                                <div class="ms-auto pt-2 bd-highlight js-order-group">
                                    <button class="js-btn-orders btn btn-sm btn-warning"> order </button>
                                    <div class="js-btn-group-input input-group input-group-sm input-group-md" style="width:95px; display:none">
                                        <button class="btn js-btn-arrow-spinner-min btn-warning btn-outline-none" type="button" id="button-addon1">-</button>
                                        <input type="number" class="js-input-spinner-number form-control" min="0" max="100" value="0" disabled>
                                        <button class="btn js-btn-arrow-spinner-plus btn-warning " type="button" id="button-addon1">+</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card btn btn-danger bg-danger text-light">
                    <div class="d-flex bd-highlight mb-3" style="height:30px;">
                        <div class="p-2 bd-highlight ">
                            <div class="d-inline-block bg-warning rounded-circle text-center" style="width: 30px; height:30px; line-height:30px">
